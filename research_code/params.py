...
arg('--train_dir', default='/data/Agriculture-Vision-2021')
arg('--val_dir', default='/data/Agriculture-Vision-2021')
arg('--test_dir', default='/data/Agriculture-Vision-2021')
arg('--dataset_df', default='/data/train_val_initial_2020-04-23.csv')
arg('--exclude_bad_labels_df')

arg('--experiments_dir', default='/data/artifacts')
arg('--class_names', nargs='+', default=['double_plant', 'planter_skip', 'water', 'waterway', 'weed_cluster', 'nutrient_deficiency', 'drydown', 'endrow'])
